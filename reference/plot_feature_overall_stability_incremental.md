...
ECS values are extracted for every resolution value and summarized using
a function (e.g. median, mean, etc.).
...
- summary_function:
  ...
  The function used to summarize the ECS values. Default is `median`.
