---
title: "Stability-based parameter assessment vignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Stability-based parameter assessment pipeline}
...
ggarrange(plotlist = plotlist, ncol = 3, nrow = 2, labels = c("A", "B", "C", "D", "E", "F"))
```
...
```{r}
pca_feature_stability_object = c(get_feature_stability(data_matrix = cuomo@assays[["SCT"]]@scale.data,
                                                       ...
                                                       ecs_thresh = 1,
                                                       algorithm = 1),
                                 get_feature_stability(data_matrix = cuomo@assays[["SCT"]]@scale.data,
...
```{r}
resolution_gridsearch = get_resolution_importance(embedding = cuomo@reductions$pca@cell.embeddings,
                                                  resolution = seq(from = 0.5, to = 1, by = 0.1),
                                                  n_neigh = 30,
                                                  n_repetitions = n_repetitions,
