...
```{r k_res_corr, fig.width = 7, fig.height=5}
...
The `merge_resolutions` merges the partitions with the same number of clusters into the same list, even if they come from different resolutions. The resulting object can be used to investigate the relationship between the number of clusters and the number of unique partitions.
...
```{r k_n_part, fig.width=7, fig.height=5}
