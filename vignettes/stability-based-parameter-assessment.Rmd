...
n_abundant = 3000
abundant_features = rownames(cuomo@assays$RNA)[order(Matrix::rowSums(cuomo@assays$RNA), decreasing=TRUE)][1:n_abundant]
...
cuomo = RunPCA(cuomo, 
               ...
               approx = F, 
               verbose = F, 
               features = intersect(abundant_features, cuomo@assays$RNA@var.features))
