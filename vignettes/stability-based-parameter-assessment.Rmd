...
ma_hv_genes_intersection = intersect(most_abundant_genes[1:3000], var_features[1:3000])
ma_hv_steps = sapply(steps, function(step) { length(intersect(most_abundant_genes[1:step], var_features[1:step])) })
```
