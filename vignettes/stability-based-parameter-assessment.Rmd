...
cuomo = RunUMAP(cuomo,reduction = "pca",
                ...
                metric = "cosine",
                verbose = F)
adj_matrix = FindNeighbors(cuomo@reductions$umap@cell.embeddings, k.param = 30, nn.method = "rann", verbose = F)$snn
...
plot_k_n_partitions(resolution_gridsearch, colour_information = "frequency_partition") + ggtitle("k - # partitions correspondence with ecs threshold = 1")
```
